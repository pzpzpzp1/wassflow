...
%% try 3d volume render ala matlab. yuck it's pretty awful. forget this. well, rbfs and levelsets might be good though
clear all;
N=5000;
X = rand(N,3);
[V,F] = icosphere(2);
...
%% optimal transport between oriented rectangles
close all; clear all;
